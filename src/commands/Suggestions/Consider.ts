...
export default class SuggestionConsidered extends Command {
        ...
        if (suggestion) {
            ...
            try {
                await suggestionAuthor.send({
                    embeds: [newEmbed.setTitle('Your suggestion has been considered!')]
                });
            } catch (err) {}
            ...
            await this.client.db.suggestion.update({
                ...
                data: {
                    comment,
                    state: SuggestionStates.Considered
                }
            });
            ...
            responseEmbed = new Embed('success', message.member)
                ...
                .setDescription(
                    `Suggestion #${suggestionId} has been considered! Check it out in ${this.client.tvf.channels.suggestions.toString()}!`
                );
        } else {
