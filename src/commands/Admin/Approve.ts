...
class Approve extends TVFCommand {
    constructor() {
        super('approve', {
            aliases: ['approve'],
        ...
        this.examples = ['approve 1', 'approve 2 This is a really cool idea!'];
    }

    async exec(msg: Message, { id, comment }: { id: number; comment: string }) {
        // Update the suggestion status
        this.client.social.updateSuggestionStatus(
            id,
            this.client.constants.SuggestionStatus.Approved,
            msg.author,
            comment,
        );
