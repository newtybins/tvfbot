...
//         //     // Level up!
//         //     if (
//         //         (xp >= this.client.social.xpFor(level + 1) &&
//         //             !this.client.tvfChannels.venting.includes(
...
//         //                 ];
//         //             const xpAway =
//         //                 this.client.social.xpFor(nextLevelRole.level) -
//         //                 this.client.social.xpFor(currentLevelRole.level);
//         //             description += `\nYou are now ${xpAway.toLocaleString()} xp from becoming a ${
//         //                 nextLevelRole.name
//         //             } <3`;
//         //         }
